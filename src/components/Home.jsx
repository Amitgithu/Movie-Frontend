          ...
          <div className="collapse navbar-collapse" id="navbarCollapse">
            ...
            <div className="navbar-nav">
              {user ? (
                ...
                <>
                  <Link to={"/register"} className="nav-item nav-link text-white text-center">
                    Register
                  </Link>
                  <Link to={"/login"} className="nav-item nav-link text-white text-center">
                    Login
                  </Link>
                </>
              )}
        ...
        <div className="container mt-4">
          ...
          <div className="row">
            {publicPlaylists.map((playlist) => (
              <div className="col-6 col-md-4 col-lg-3 mb-4" key={playlist._id}>
                <div className="card h-100 playlist-card">
                  <div className="card-body text-center">
                    <h5 className="card-title playlist-title">
                      {playlist.playlistName}
                    </h5>
                    <p className="card-text playlist-creator">

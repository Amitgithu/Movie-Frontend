      ...
      <div className="container mt-4">
        <div className="row">
          <div className="col-12">
            <div className="card user-card border border-dark mb-4">
          ...
          <div className="col-12">
            <div className="card playlists-card mb-4 border border-dark">
              <div className="card-body">
                <h5 className="card-title text-center text-primary">Private Playlists</h5>
                {privatePlaylists.length > 0 ? (
                  <div className="row">
                    {privatePlaylists.map((playlist) => (
                      <div className="col-6 col-sm-4 col-lg-3 mb-4" key={playlist._id}>
                        <div className="card h-100 playlist-card">
                          <div className="card-body text-center">
                            <h5 className="card-title playlist-title">{playlist.playlistName}</h5>
                            <p className="card-text playlist-movies">Total Movies: {playlist.movies.length}</p>
                            <Link to={`/playlist/${playlist._id}`} className="btn btn-primary playlist-btn m-1">View Playlist</Link>
                            <button
                              className="btn btn-danger playlist-btn m-1"
        ...
        <div className="row">
          <div className="col-12 p-3">
            <div className="card playlists-card border border-dark">
              <div className="card-body">
                <h5 className="card-title text-center text-primary">Public Playlists</h5>
